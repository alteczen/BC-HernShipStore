var Cart = {
	...
	UpdateShippingCost: function()
	{
		...
		/**CUSTOM**/
		var selRate = $('.EstimatedShippingMethods input[type=radio]:checked').val();
		var selInput = '<input name="selectedShippingMethod" value="' + selRate + '" style="vertical-align: middle;" type="radio" checked>';
		$('#shippingHolder').html(selInput);		
		$('#cartForm').submit();
	},
